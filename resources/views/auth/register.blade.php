<x-guest-layout>
  <form method="POST" action="{{ route('register') }}">
    ...
    <div
      ...
      <!-- display left image -->
      <div class="bg-cover lg:w-1/2 flex justify-center items-center align-middle">
        <img src="{{ asset('img/ziegers.png') }}" alt="">
      </div>
      ...
      <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
        ...
        <form>
          ...
          <div class="mt-6 flex justify-evenly items-center">
            ...
            <a class="underline text-sm ml-2 text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              href="{{ route('user.guest-login') }}">

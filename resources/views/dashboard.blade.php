  ...
  @if (auth()->user()->role == 'customer')
    ...
    <div class="w-full flex-grow flex flex-col items-center justify-center  space-y-8">
      ...
      <div class="flex flex-col items-center text-center">
        ...
        <h6 class="text-lg text-purple-800">Welcome {{ Auth::user()->name }} to Ziegers Printing System</h6>
      </div>
        ...
        <div class="w-full h-full">
          <div class="p-4 sm:p-6 space-y-2 sm:space-y-6">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              ...
              <!-- Card Total Users -->
              <div
                class="flex bg-white drop-shadow-lg shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
              ...
              <div class="-m-1.5 overflow-x-auto">
                <div class="p-1.5 min-w-full inline-block align-middle">
                  <div
                    ...
                    <!-- Header -->
                    <div
                      class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center dark:border-neutral-700">
                      <div>
